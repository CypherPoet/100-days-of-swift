    ...
    enum Action {
        ...
        var title: String {
            ...
            case .showInfo:
                return "Tell me more..."
            case .remindMeLater:
                return "Remind me in a day"
            }
        }
        
        var notificationAction: UNNotificationAction {
            switch self {
            case .showInfo, .remindMeLater:
        ...
        var notificationCategory: UNNotificationCategory {
            ...
            case .earthRotation:
                return .init(
                    ...
                    actions: [Action.showInfo.notificationAction, Action.remindMeLater.notificationAction],
                    intentIdentifiers: []
                )
            }
        }
...
extension LocalNotification {
    enum Content {
        ...
        var requestContent: UNNotificationContent {
            switch self {
            case .earthRotation:
                return makeEarthRotationContent()
            }
        }
    }
}
...
private extension LocalNotification {
    static func makeEarthRotationContent() -> UNNotificationContent {
